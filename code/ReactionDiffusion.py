...
def setModelParams(model):
    ...
    if model == "FN":
        ...
        pvals = [{"Du":0.14, "Dv":0.06, "F":0.035, "k":0.065,"myCmap":plt.cm.copper,"edgeMax":False,"dt":1,"dx":1},
                {"Du":0.625, "Dv":0.375, "F":0.042, "k":0.06,"myCmap":plt.cm.cubehelix,"edgeMax":False,"dt":1,"dx":1},
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--timesteps", type=int, help="Number of timesteps to simulate (default 8000)",default=2000)
